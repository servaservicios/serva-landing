...
const configs: Record<string, CatConfig> = {
  ...
  'plomeria': {
    ...
    image: '/images/Corrección de Fugas.png',
    objectPosition: 'center center',
...
const serviceConfigs: Record<string, ServiceConfig> = {
  ...
  'limpieza-trampas':           { subtitle: 'Mantenimiento preventivo certificado', image: '/images/Limpieza de Trampas de Grasa.png', objectPosition: 'center center' },
  // Aire acondicionado
  'mantenimiento-ac':           { subtitle: 'Eficiencia y vida útil prolongada', image: '/images/Mantenimiento de AC Central y Minisplit.png', objectPosition: 'center center' },
  'limpieza-campanas':          { subtitle: 'Ambiente libre de grasas', image: '/images/Limpieza de Campanas y Ductos.png', objectPosition: 'center center' },
  'cambio-filtros':             { subtitle: 'Calidad del aire garantizada', image: '/images/Cambio de Filtros.png', objectPosition: 'center center' },
  'extractor-hongo':            { subtitle: 'Extracción limpia y segura', image: '/images/Limpieza de Hongo Extractor.png', objectPosition: 'center center' },
  // Plomería
  'diagnosticos':               { subtitle: 'Detección temprana de fallas', image: '/images/Diagnósticos.png', objectPosition: 'center center' },
  'fugas':                      { subtitle: 'Reparación permanente', image: '/images/Corrección de Fugas.png', objectPosition: 'center center' },
  'desazolves':                 { subtitle: 'Tuberías despejadas y funcionales', image: '/images/Desazolves.png', objectPosition: 'center center' },
  'llaves-valvulas':            { subtitle: 'Instalación y reemplazo', image: '/images/Cambio de Llaves y Válvulas.png', objectPosition: 'center center' },
  // Fumigación
  'insectos-rastreros':         { subtitle: 'Control efectivo de largo plazo', image: '/images/Insectos Rastreros.png', objectPosition: 'center center' },
  'cucaracha-alemana':          { subtitle: 'Protocolo especializado', image: '/images/Cucaracha Alemana.png', objectPosition: 'center center' },
  ...
  'armado-muebles':             { subtitle: 'Ensamble profesional en sitio', image: '/images/Armado de Muebles.png', objectPosition: 'center center' },
  'reparaciones-generales':     { subtitle: 'Un técnico para todo', image: '/images/Reparaciones Generales.png', objectPosition: 'center center' },
  // Otros
  'mudanzas':                   { subtitle: 'Traslado seguro de tus pertenencias', image: '/images/Mudanzas.png', objectPosition: 'center center' },
}
