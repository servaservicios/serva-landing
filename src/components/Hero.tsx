...
export default function Hero() {
  return (
    <section
      id="inicio"
      className="min-h-svh bg-white relative overflow-hidden flex flex-col"
      aria-label="Inicio"
    >
      {/* Dot grid */}
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(135deg, rgba(255,255,255,0.78) 0%, rgba(255,255,255,0.68) 100%)',
          }}
          aria-hidden
        />
      </div>
          ...
          <div className="lg:grid lg:grid-cols-[1fr_360px] lg:gap-16 xl:gap-24 lg:items-center">
            ...
            >
              ...
              <motion.h1
                ...
                className="font-black text-ink-950 leading-[0.9] tracking-tight mb-8"
              ...
              <motion.p
                ...
                className="text-ink-700 text-lg md:text-xl max-w-[500px] leading-relaxed mb-7"
              >
                Limpieza profesional y mantenimiento para{' '}
                <span className="text-brand font-extrabold">hogares y empresas</span>.{' '}
                <span className="text-ink-900 font-semibold">Un solo punto de contacto</span>{' '}
                ...
                {trustBadges.map((badge, i) => (
                  <Fragment key={badge.label}>
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-ink-600 text-[13px] font-medium">{badge.label}</span>
                    </div>
                    {i < trustBadges.length - 1 && (
                      <span className="text-ink-400 text-xs select-none leading-none" aria-hidden>·</span>
                    )}
                  </Fragment>
                ))}
              </motion.div>
              ...
              >
                <a
                  ...
                  className="inline-flex items-center gap-2.5 bg-brand text-ink-950 font-extrabold text-base px-7 py-3.5 rounded-xl hover:bg-brand-dark transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-white"
                >
                ...
                <a
                  href="#servicios"
                  className="group inline-flex items-center gap-2 border border-ink-400/60 text-ink-700 font-bold text-sm px-5 py-2.5 rounded-xl hover:border-brand/70 hover:text-brand transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-white"
                >
                  Ver servicios
            ...
            <div className="hidden lg:flex flex-col gap-3">
                ...
                <motion.div
                  ...
                  className={`rounded-2xl px-7 py-5 border ${
                    i === 0
                      ...
                      : 'bg-ink-100/70 border-ink-200/70'
                  }`}
                >
                  <p
                  ...
                  <p className="text-ink-600 text-sm font-semibold">{stat.label}</p>
                </motion.div>
              ))}
              ...
              <motion.div
                ...
                className="rounded-2xl px-7 py-5 border bg-ink-50/90 border-ink-200/60"
              >
                {/* Live status badge */}
                ...
                {/* Hairline separator */}
                <div className="border-t border-ink-200/60 mb-4" />

                {/* Body text */}
                <p
                  className="font-extrabold text-ink-900 leading-snug"
      ...
      <motion.div
        ...
        className="relative z-10 border-t border-ink-200/50 py-4"
      >
        ...
        <div className="overflow-x-auto hide-scrollbar px-6 md:px-10">
          <nav
            ...
            style={{
              background: 'oklch(98% 0.004 152 / 0.85)',
              backdropFilter: 'blur(20px)',
              WebkitBackdropFilter: 'blur(20px)',
              border: '1px solid oklch(80% 0.010 152 / 0.40)',
              borderRadius: '14px',
              boxShadow:
                '0 0 0 1px oklch(73.5% 0.186 152 / 0.07), ' +
                'inset 0 1px 0 oklch(100% 0 0 / 0.60), ' +
                '0 8px 24px oklch(50% 0.012 152 / 0.10)',
            }}
          >
            {tickerCategories.map((cat, i) => (
              <Fragment key={cat.id}>
                <a
                  ...
                  className="group relative flex flex-1 items-center justify-center gap-2 px-4 py-4 text-ink-600 text-[13px] font-semibold whitespace-nowrap transition-colors duration-200 hover:text-brand focus-visible:outline-none focus-visible:text-brand"
                ...
                {i < tickerCategories.length - 1 && (
                  <div
                    ...
                    style={{ background: 'oklch(70% 0.010 152 / 0.25)' }}
                    aria-hidden
                  />
                )}
              </Fragment>
